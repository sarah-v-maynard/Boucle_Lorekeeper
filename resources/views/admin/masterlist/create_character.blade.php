...
@section('admin-content')
    ...
    @else
        ...
        <div class="form-group">
            {!! Form::label('Gender') !!}
            {!! Form::text('BOUC_gender', old('BOUC_gender'), ['class' => 'form-control']) !!}
        </div>
    ...
    {{-- EXT: Character Genetics Data - Genetics Helper Fields --}}
...
@section('scripts')
    @parent
    @include('widgets._genome_create_edit_js') {{-- EXT: Character Genetics Data --}}
