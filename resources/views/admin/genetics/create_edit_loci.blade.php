...
@section('admin-content')
        ...
        <div class="col-6">
            <div class="form-group">
                {!! Form::label('type', 'Type') .
                    add_help(
                        'Standard are normal genes (eg. Aa). Gradient is for genes like rufus factors, with a large array of  binary on/off genes (eg. +-+--+++-+), and numbers are for straight up numbers (eg. 50, 12, 251). Type cannot be changed after creation.',
                    ) !!}
        ...
        <div class="col-6">
            <div class="form-group">
                {!! Form::label('length', 'Length') .
                    add_help(
                        'For standard genes, this should be set to 2 (one for each allele in the pair). For gradients, it should be a multiple of 2 (one for the maternal set and one for the paternal set) and cannot be larger than 64. For numbers, it can be anything between 0 and 255.',
                    ) !!}
    ...
    @if ($category->id && $category->type == 'gene')
        ...
        <p>Add new alleles to this gene group here. The checkbox determines dominance. The first text area determines the identifier and the second is an optional modifier. Use the textbox next to the add allele button to set all the identifiers at once.
        </p>
