...
@section('admin-content')
    ...
    <h3>Myo Settings</h3>
    <p class="alert alert-info">Settings input here will be applied to <strong>every single myo</strong> generated by the roller. Only the genomes and the offspring number placed in the myo name will be unique. <strong>Traits, as well as any variation in
            species or rarity, will need to be manually set after the myos are generated.</strong></p>
    ...
    <div class="row">
        <div class="col-12 col-sm-6">
            ...
            <div class="form-group">
                ...
                {!! Form::label('genome_visibility', 'Genome Visibility') .
                    add_help("The visibility level of all these children's genomes. (The default site setting for genome visibility is " . ($dVis < 1 ? 'Completely Hidden' : ($dVis == 1 ? 'Half-Hidden' : 'Fully Visible')) . '.)') !!}
        ...
        <div class="col-12 col-sm-6">
            ...
            <div class="form-group" id="subtypes">
                {!! Form::label('subtype_id', 'Subtype (Optional)') .
                    add_help(
